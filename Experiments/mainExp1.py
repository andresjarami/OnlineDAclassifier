...
for featureSet in [1]:
    ...
    for info in [['Capgmyo_dbb', 1, 10]]:
        ...
        nameFile = folder + '_' + typeDatabase + '_FS_' + str(featureSet) + '_sP_' + str(
            ...
            initialExpTime) + '_fiTime_' + str(finalExpTime) + 'SUP.csv'
        ...
        functionsExp1.evaluation_Supervised(featureSet, nameFile, startPerson, endPerson, printResults, shotStart,
                                            initialExpTime, finalExpTime, typeDatabase)
