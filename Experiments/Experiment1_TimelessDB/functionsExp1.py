    ...
    for person in range(startPerson, endPerson + 1):
        ...
        for seed in range(initialTime, finalTime + 1):
            ...
            for rand in list(permutationUnlabeledGestures):
                ...
                name = type_DA + '_' + 'weak'
                predictedLabels = SemiSupervised.predicted_labels(trainFeatures, LDA_weak, classes, type_DA)
                for cla in range(classes):
                    LDA_weak.at[rand[1] - 1, 'CL' + str(cla + 1)] += predictedLabels[cla]
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_weak)
                ...
                LDA_incre_proposed, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    labeledGesturesLabels, 'LDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_proposed)
                ...
                LDA_incre_label, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    LDA_incre_label, classes, trainFeatures, rand[1], 'LDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_label)
                ...
                LDA_incre_sequential, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    LDA_incre_sequential, classes, trainFeatures, rand[1], 'LDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_sequential)
                ...
                LDA_incre_supervised, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    LDA_incre_supervised, classes, trainFeatures, rand[1], 'LDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_supervised)
                ...
                LDA_incre_Nigam_01, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    LDA_incre_Nigam_01, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=0.1)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_01)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.2)
                LDA_incre_Nigam_02, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    LDA_incre_Nigam_02, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=0.2)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_02)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.4)
                LDA_incre_Nigam_04, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    LDA_incre_Nigam_04, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=0.4)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_04)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.6)
                LDA_incre_Nigam_06, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    LDA_incre_Nigam_06, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=0.6)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_06)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.8)
                LDA_incre_Nigam_08, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    LDA_incre_Nigam_08, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=0.8)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_08)
                name = type_DA + '_' + 'incre_Nigam_' + str(1.0)
                LDA_incre_Nigam_10, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    LDA_incre_Nigam_10, classes, trainFeatures, rand[1], 'LDA', weight_Nigam=1)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_Nigam_10)
                ...
                LDA_incre_threshold_02, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    LDA_incre_threshold_02, classes, trainFeatures, rand[1], 'LDA', threshold=0.2)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_02)
                name = type_DA + '_' + 'incre_threshold_' + str(0.3)
                LDA_incre_threshold_03, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_03, classes, trainFeatures, rand[1], 'LDA', threshold=0.3)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_03)
                name = type_DA + '_' + 'incre_threshold_' + str(0.4)
                LDA_incre_threshold_04, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_04, classes, trainFeatures, rand[1], 'LDA', threshold=0.4)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_04)
                name = type_DA + '_' + 'incre_threshold_' + str(0.5)
                LDA_incre_threshold_05, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_05, classes, trainFeatures, rand[1], 'LDA', threshold=0.5)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_05)
                name = type_DA + '_' + 'incre_threshold_' + str(0.6)
                LDA_incre_threshold_06, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_06, classes, trainFeatures, rand[1], 'LDA', threshold=0.6)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_06)
                name = type_DA + '_' + 'incre_threshold_' + str(0.7)
                LDA_incre_threshold_07, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_07, classes, trainFeatures, rand[1], 'LDA', threshold=0.7)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_07)
                name = type_DA + '_' + 'incre_threshold_' + str(0.8)
                LDA_incre_threshold_08, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_08, classes, trainFeatures, rand[1], 'LDA', threshold=0.8)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_08)
                name = type_DA + '_' + 'incre_threshold_' + str(0.9)
                LDA_incre_threshold_09, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    LDA_incre_threshold_09, classes, trainFeatures, rand[1], 'LDA', threshold=0.9)
                # results.at[idx, 'error_' + name] = errorPerGesture(LDA_incre_threshold_09)

                ###################################
                type_DA = 'QDA'

                name = type_DA + '_' + 'weak'
                predictedLabels = SemiSupervised.predicted_labels(trainFeatures, QDA_weak, classes, type_DA)
                for cla in range(classes):
                    QDA_weak.at[rand[1] - 1, 'CL' + str(cla + 1)] += predictedLabels[cla]
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_weak)
                ...
                QDA_incre_proposed, results.at[idx, 'time' + '_' + name], results.at[
                    ...
                    labeledGesturesLabels, 'QDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_proposed)
                print('time QDA', results.at[idx, 'time' + '_' + name])

                name = type_DA + '_' + 'incre_labels'
                QDA_incre_label, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_labels(
                    QDA_incre_label, classes, trainFeatures, rand[1], 'QDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_label)

                name = type_DA + '_' + 'incre_sequential'
                QDA_incre_sequential, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_sequential_labels(
                    QDA_incre_sequential, classes, trainFeatures, rand[1], 'QDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_sequential)

                name = type_DA + '_' + 'incre_supervised'
                QDA_incre_supervised, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_supervised(
                    QDA_incre_supervised, classes, trainFeatures, rand[1], 'QDA')
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_supervised)

                name = type_DA + '_' + 'incre_Nigam_' + str(0.1)
                QDA_incre_Nigam_01, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_01, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=0.1)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_01)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.2)
                QDA_incre_Nigam_02, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_02, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=0.2)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_02)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.4)
                QDA_incre_Nigam_04, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_04, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=0.4)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_04)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.6)
                QDA_incre_Nigam_06, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_06, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=0.6)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_06)
                name = type_DA + '_' + 'incre_Nigam_' + str(0.8)
                QDA_incre_Nigam_08, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_08, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=0.8)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_08)
                name = type_DA + '_' + 'incre_Nigam_' + str(1.0)
                QDA_incre_Nigam_10, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_weight_Nigam(
                    QDA_incre_Nigam_10, classes, trainFeatures, rand[1], 'QDA', weight_Nigam=1)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_Nigam_10)

                name = type_DA + '_' + 'incre_threshold_' + str(0.2)
                QDA_incre_threshold_02, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_02, classes, trainFeatures, rand[1], 'QDA', threshold=0.2)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_02)
                name = type_DA + '_' + 'incre_threshold_' + str(0.3)
                QDA_incre_threshold_03, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_03, classes, trainFeatures, rand[1], 'QDA', threshold=0.3)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_03)
                name = type_DA + '_' + 'incre_threshold_' + str(0.4)
                QDA_incre_threshold_04, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_04, classes, trainFeatures, rand[1], 'QDA', threshold=0.4)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_04)
                name = type_DA + '_' + 'incre_threshold_' + str(0.5)
                QDA_incre_threshold_05, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_05, classes, trainFeatures, rand[1], 'QDA', threshold=0.5)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_05)
                name = type_DA + '_' + 'incre_threshold_' + str(0.6)
                QDA_incre_threshold_06, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_06, classes, trainFeatures, rand[1], 'QDA', threshold=0.6)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_06)
                name = type_DA + '_' + 'incre_threshold_' + str(0.7)
                QDA_incre_threshold_07, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_07, classes, trainFeatures, rand[1], 'QDA', threshold=0.7)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_07)
                name = type_DA + '_' + 'incre_threshold_' + str(0.8)
                QDA_incre_threshold_08, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_08, classes, trainFeatures, rand[1], 'QDA', threshold=0.8)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_08)
                name = type_DA + '_' + 'incre_threshold_' + str(0.9)
                QDA_incre_threshold_09, results.at[idx, 'time' + '_' + name], results.at[
                    idx, 'w_predicted' + '_' + name] = SemiSupervised.model_incre_label_threshold(
                    QDA_incre_threshold_09, classes, trainFeatures, rand[1], 'QDA', threshold=0.9)
                # results.at[idx, 'error_' + name] = errorPerGesture(QDA_incre_threshold_09)
                ...
                LDA_incre_proposed.to_pickle(
                    'resultModels/' + 'LDA_incre_proposed' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_label.to_pickle(
                    'resultModels/' + 'LDA_incre_label' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_sequential.to_pickle(
                    'resultModels/' + 'LDA_incre_sequential' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_supervised.to_pickle(
                    'resultModels/' + 'LDA_incre_supervised' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_01.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_01' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_02.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_02' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_04.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_04' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_06.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_06' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_08.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_08' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_Nigam_10.to_pickle(
                    'resultModels/' + 'LDA_incre_Nigam_10' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_02.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_02' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_03.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_03' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_04.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_04' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_05.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_05' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_06.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_06' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_07.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_07' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_08.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_08' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                LDA_incre_threshold_09.to_pickle(
                    'resultModels/' + 'LDA_incre_threshold_09' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')

                QDA_incre_proposed.to_pickle(
                    'resultModels/' + 'QDA_incre_proposed' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_label.to_pickle(
                    'resultModels/' + 'QDA_incre_label' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_sequential.to_pickle(
                    'resultModels/' + 'QDA_incre_sequential' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_supervised.to_pickle(
                    'resultModels/' + 'QDA_incre_supervised' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_01.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_01' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_02.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_02' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_04.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_04' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_06.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_06' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_08.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_08' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_Nigam_10.to_pickle(
                    'resultModels/' + 'QDA_incre_Nigam_10' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_02.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_02' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_03.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_03' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_04.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_04' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_05.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_05' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_06.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_06' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_07.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_07' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_08.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_08' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
                QDA_incre_threshold_09.to_pickle(
                    'resultModels/' + 'QDA_incre_threshold_09' + '_' + typeDatabase + '_featureSet_' + str(
                        featureSet) + '_person_' + str(person) + '_shotStart_' + str(shotStart) + '_seed_' + str(
                        seed) + '.pkl')
...
def errorPerGesture(model):
    classes = len(model.index)
    auxColumns = []
    for cla in range(classes):
        auxColumns.append('CL' + str(cla + 1))
    confMatrix = model[auxColumns].values
    return 1 - np.diagonal(confMatrix).sum() / np.sum(confMatrix)
