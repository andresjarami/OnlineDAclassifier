...
def evaluation(dataMatrix, classes, peoplePriorK, featureSet, numberShots, nameFile, startPerson, endPerson,
    ...
    for person in range(startPerson, endPerson + 1):
        ...
        semiSupervisedLearningModelLDA = fewShotModel.copy()
        semiSupervisedLearningModelQDA = fewShotModel.copy()
        semiSupervisedLearning_adaptationModelLDA = fewShotModel.copy()
        semiSupervisedLearning_adaptationModelQDA = fewShotModel.copy()
        ...
        for shot in range(shotStart + 1, numberShots + 1):
            ...
            results, idx, semiSupervisedLearningModelLDA, semiSupervisedLearningModelQDA, \
            semiSupervisedLearning_adaptationModelLDA, semiSupervisedLearning_adaptationModelQDA = \
                resultsDataframeUnsupervised(
                    trainFeatures, trainLabels, classes, allFeaturesPK, results, testFeaturesTransform, testLabels, idx,
                    person, subset, featureSet, nameFile, printR, fewShotFeatures, fewShotLabels,
                    semiSupervisedLearningModelLDA, semiSupervisedLearningModelQDA,
                    semiSupervisedLearning_adaptationModelLDA, semiSupervisedLearning_adaptationModelQDA, fewShotModel,
...
def resultsDataframeUnsupervised(trainFeatures, trainLabels, classes, allFeatures, results, testFeatures, testLabels,
                                 idx, person, subset, featureSet, nameFile, printR, fewShotFeatures, fewShotLabels,
                                 semiSupervisedLearningModelLDA, semiSupervisedLearningModelQDA,
                                 semiSupervisedLearning_adaptationModelLDA, semiSupervisedLearning_adaptationModelQDA,
    ...
    semiPostProbabilitiesLDA = DA_Classifiers.scoreModelLDA_ClassificationUnsupervised(trainFeatures,
                                                                                       semiSupervisedLearningModelLDA,
                                                                                       classes, trainLabels)

    semiPostProbabilitiesQDA = DA_Classifiers.scoreModelQDA_ClassificationUnsupervised(trainFeatures,
                                                                                       semiSupervisedLearningModelQDA,
                                                                                       classes, trainLabels)

    semi_adaptationPostProbabilitiesLDA = DA_Classifiers.scoreModelLDA_ClassificationUnsupervised(trainFeatures,
                                                                                                  semiSupervisedLearning_adaptationModelLDA,
                                                                                                  classes, trainLabels)

    semi_adaptationPostProbabilitiesQDA = DA_Classifiers.scoreModelQDA_ClassificationUnsupervised(trainFeatures,
                                                                                                  semiSupervisedLearning_adaptationModelQDA,
                                                                                                  classes, trainLabels)

    semiSupervisedLearningModelLDA, _, _, _, _, _ = adaptive.OurModelUnsupervisedAllProb(
        semiSupervisedLearningModelLDA, semiPostProbabilitiesLDA, classes, allFeatures, fewShotFeatures, fewShotLabels,
        fewShotModel, step, 'LDA', 1, typeDatabase)

    semiSupervisedLearningModelQDA, _, _, _, _, _ = adaptive.OurModelUnsupervisedAllProb(
        semiSupervisedLearningModelQDA, semiPostProbabilitiesQDA, classes, allFeatures, fewShotFeatures, fewShotLabels,
        fewShotModel, step, 'QDA', 1, typeDatabase)

    semiSupervisedLearning_adaptationModelLDA, _, _, _, _, _ = adaptive.OurModelUnsupervisedAllProb(
        semiSupervisedLearning_adaptationModelLDA, semi_adaptationPostProbabilitiesLDA, classes, allFeatures,
        fewShotFeatures, fewShotLabels,
        adaptedModel, step, 'LDA', 1, typeDatabase)

    semiSupervisedLearning_adaptationModelQDA, _, _, _, _, _ = adaptive.OurModelUnsupervisedAllProb(
        semiSupervisedLearning_adaptationModelQDA, semi_adaptationPostProbabilitiesQDA, classes, allFeatures,
        fewShotFeatures, fewShotLabels,
        adaptedModel, step, 'QDA', 1, typeDatabase)
    ...
    return results, idx, semiSupervisedLearningModelLDA, semiSupervisedLearningModelQDA, \
           semiSupervisedLearning_adaptationModelLDA, semiSupervisedLearning_adaptationModelQDA
