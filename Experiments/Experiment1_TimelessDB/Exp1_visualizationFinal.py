...
def vectors_calculation(results, rows):
    ...
    return LDA_Ideal, LDA_NoAdapted, LDA_PostProb, LDA_PostProb_MSDA, LDA_Adapted, LDA_PostProb_Adapted, \
           LDA_PostProb_MSDA_Adapted, QDA_Ideal, QDA_NoAdapted, QDA_PostProb, QDA_PostProb_MSDA, QDA_Adapted, \
           QDA_PostProb_Adapted, QDA_PostProb_MSDA_Adapted
...
def graphs(rows1, rows2, database, LDA_Ideal_1, LDA_NoAdapted_1, LDA_PostProb_1, LDA_PostProb_MSDA_1, LDA_Adapted_1,
           LDA_PostProb_Adapted_1, LDA_PostProb_MSDA_Adapted_1, QDA_Ideal_1, QDA_NoAdapted_1, QDA_PostProb_1,
           QDA_PostProb_MSDA_1, QDA_Adapted_1, QDA_PostProb_Adapted_1, QDA_PostProb_MSDA_Adapted_1, LDA_Ideal_2,
           ...
           yLDA_V, yQDA_V, yLDA_O, yQDA_O, samplesInMemory, featureSet):
    x1 = [*range(rows1 + 1)]
    x2 = [*range(rows2 + 1)]
...
def analysis1(folder, database, samplesInMemory, featureSet, times):
    results1, rows1 = uploadResultsDatabase(folder, database, samplesInMemory, featureSet, times, shotStart=1)
    # results2, rows2 = AUXuploadResultsDatabase(folder, database, samplesInMemory, featureSet, shotStart=1)
    results2, rows2 = uploadResultsDatabase(folder, database, samplesInMemory, featureSet, times, shotStart=2)

    results_Old, x_Old = uploadResultsDatabasesVF1('../ResultsExp1_RQ1/', database, windowSize='295')

    LDA_Ideal_1, LDA_NoAdapted_1, LDA_PostProb_1, LDA_PostProb_MSDA_1, LDA_Adapted_1, LDA_PostProb_Adapted_1, \
    LDA_PostProb_MSDA_Adapted_1, QDA_Ideal_1, QDA_NoAdapted_1, QDA_PostProb_1, QDA_PostProb_MSDA_1, QDA_Adapted_1, \
    QDA_PostProb_Adapted_1, QDA_PostProb_MSDA_Adapted_1 = vectors_calculation(results1, rows1)
    ...
    yLDA, yQDA, yLDA_L, yQDA_L, yLDA_V, yQDA_V, yLDA_O, yQDA_O = vectors_calculation_Old(results_Old, 1,
                                                                                         featureSet)
    graphs(rows1, rows2, database, LDA_Ideal_1, LDA_NoAdapted_1, LDA_PostProb_1, LDA_PostProb_MSDA_1, LDA_Adapted_1,
           LDA_PostProb_Adapted_1, LDA_PostProb_MSDA_Adapted_1, QDA_Ideal_1, QDA_NoAdapted_1, QDA_PostProb_1,
           QDA_PostProb_MSDA_1, QDA_Adapted_1, QDA_PostProb_Adapted_1, QDA_PostProb_MSDA_Adapted_1, LDA_Ideal_2,
           LDA_NoAdapted_2, LDA_PostProb_2, LDA_PostProb_MSDA_2, LDA_Adapted_2, LDA_PostProb_Adapted_2,
           LDA_PostProb_MSDA_Adapted_2, QDA_Ideal_2, QDA_NoAdapted_2, QDA_PostProb_2, QDA_PostProb_MSDA_2,
...
analysis1(folder='resultsFinal/', database='Nina5', samplesInMemory=0, featureSet=1,times=5)
analysis1(folder='resultsFinal/', database='Cote', samplesInMemory=0, featureSet=1, times=5)
