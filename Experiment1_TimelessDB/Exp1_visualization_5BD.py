...
# for info in [['Cote', 'LDA', 0.95, 0.98], ['Cote', 'QDA', 0.91, 0.96], ['Nina5', 'LDA', 0.56, 0.62],
#              ['Nina5', 'QDA', 0.45, 0.64], ['LongTerm3DC', 'LDA', 0.64, 0.75], ['LongTerm3DC', 'QDA', 0.4, 0.55],
#              ['Capgmyo_dbb', 'LDA', 0.83, 0.94], ['Capgmyo_dbb', 'QDA', 0.65, 0.77], ['EPN_612', 'LDA', 0.56, 0.6],
#              ['EPN_612', 'QDA', 0.51, 0.6]]:
for info in [['Cote', 'LDA', 0.95, 1], ['Cote', 'QDA', 0.91, 1]]:
    for folder_idx in range(4):
        ...
        for p in ax.patches:
            b = p.get_bbox()
            ax.annotate("{:.3f}".format(b.y1 + b.y0), (p.get_x() * 1.005, p.get_height() * 1.005))
